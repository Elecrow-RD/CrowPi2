...
1. [Which Raspberry Pi model(s) are recommended for running the Crowpi2 software?](./PiModels.md#which-raspberry-pi-models-are-recommended-for-running-the-crowpi2-software)  
1. [Why can't the SDA0 (BCM_GPIO-0) pin be used?](./SDA0.md#why-cant-the-sda0-bcm_gpio-0-pin-be-used)  
1. [Power shuts off automatically after about 30 seconds during boot up.](./PowerShutsOff.md#power-shuts-off-automatically-after-about-30-seconds-during-boot-up)  
1. [What are the internal dimensions of the storage tray for Power Bank?](./StorageTray.md#what-are-the-internal-dimensions-of-the-storage-tray-for-power-bank)  
1. [What are the specifications of the Power Bank that came with the Advanced and Deluxe Kit?](./PowerBank.md#what-are-the-specifications-of-the-power-bank-that-came-with-the-advanced-and-deluxe-kit)  
1. [Is there a user guide available for the Power Bank that came with the Advanced and Deluxe Kit?](./PowerBankUG.md#is-there-a-user-guide-available-for-the-power-bank-that-came-with-the-advanced-and-deluxe-kit)  
1. [Where can I find the source code of all the learning lessons?](./LessonDir.md#where-can-i-find-the-source-code-of-all-the-learning-lessons)  
...
1. [No audio sound after a system upgrade (sudo apt full-upgrade).](./NoAudio.md#no-audio-sound-after-a-system-upgrade-sudo-apt-full-upgrade)  
